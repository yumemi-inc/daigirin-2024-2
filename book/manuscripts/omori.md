...
日頃からアニメが好きそうなエンジニアを X でフォローしたり、直接会った時はアニメの話題を出してみたり、アニメの話題で会話できそうな勉強会（アイドルマスターが好きなエンジニアが集まる勉強会）に参加してみたりしていました。
...
イベントページに会の趣旨や会のテーマのベースになっている、にしこりさぶろ〜(@subroh_0508)さんのスライドのリンクを記載していましたが、発表者に伝わっているが不安でした。

そんな不安を抱えていましたが、にしこりさぶろ〜さんのトークを最初にしていただいたおかげで、その後発表する方々や参加者の方々に雰囲気が伝わり、問題なく会を終えることができました。

アイドルマスターのトークから始まり、アイドルマスターミリオンライブのポテトチップスを持ち込んでいただいたり、プリキュアのウエハースが箱で持ち込んでいただいたりなど参加者の皆さんによって賑やかでアニメを中心に参加者の皆さんが盛り上がれたのかなと思います。すべての参加者の方々によって支えられていました。
...
「エンジニアニメ」の勉強会も数回開催していますが、すべてこのような会場をコミュニティに貸してくださる企業に助けていただいています。
...
私の場合は次のような順で勉強会の開催し、さまざまな方々と交流することができました。

1. エンジニアとアニメの話題で交流したいと思う
2. ぼんやりとアニメが好きそうなエンジニアに話しかける
3. 私の好みな発信をされている方をみつける
4. 勉強会のテーマや趣旨を固める
5. 出会った方に会場について相談する
6. 今までに出会った方々に告知し続ける
7. 開催する
